...
class VRHandler {
    constructor (ws, vrSocket) {
        ...
        this.makeBody = async () => {
            this.headCube = await new BlockEntity(ws, "noteblock", "head", new Vec3(0,0,0), 1);
            this.leftCube = await new BlockEntity(ws, "noteblock", "left", new Vec3(0,0,0), 0.5);
            this.rightCube = await new BlockEntity(ws, "noteblock", "right", new Vec3(0,0,0), 0.5);
